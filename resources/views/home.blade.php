    ...
    <section id="menu" class="menu">
      <div class="container" data-aos="fade-up">
        ...
        @foreach ($categories as $category)
            <li class="nav-item">
                <a class="{{ $i == 1 ? 'nav-link active show' : 'nav-link' }}" data-bs-toggle="tab" data-bs-target="#menu-{{ strtolower($category['name']) }}">
                <h4>{{ $category['name'] }}</h4>
                </a>
            </li><!-- End tab nav item -->
            @php
...
@foreach ($categories as $category)
    <div class="{{ $i == 1 ? 'active show' : '' }} tab-pane fade" id="menu-{{ strtolower($category['name']) }}">
